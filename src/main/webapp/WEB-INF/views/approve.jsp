          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <c:forEach var="item" items="${list}" varStatus="status">
                  ...
                  <td><button data="/a/request/approve/${item.id}/${item.stepOrder}/2" name="agree">同意</button><button data="/a/request/approve/${item.id}/${item.stepOrder}/1" name="reject">拒绝</button>
                      <span name="agreeed"  style="display:none" >已同意</span><span name="rejected"  style="display:none" >已拒绝</span></td>
                  </tr>
              </c:forEach>
